  ...
  <div class="modal fade" id="signup_modal_student" tabindex="-1" aria-labelledby="signup_modal_student_label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content py-2" style="border: 4px solid #A401DD; background-color: #E0CEF3;">
        ...
        <?php if (isset($ID_error_msg)) : ?>
          <?php echo $ID_error_msg; ?>
      <?php endif; ?>
        ...
        <form class="px-3 py-4" method="POST" autocomplete="off" id="studentSignupForm">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nameStudentSignup" name="nameStudentSignup" placeholder="Enter your name" style="background-color: rgba(135, 139, 243, .5);" required>
          </div>
          <div class="mb-3">
            <label for="emailStudentSignup" class="form-label fw-bold">Email</label>
            <input type="email" class="form-control" id="emailStudentSignup" name="emailStudentSignup" aria-describedby="emailStudent" placeholder="Enter your email" style="background-color: rgba(135, 139, 243, .5);" required>
          </div>
          <div class="mb-3">
